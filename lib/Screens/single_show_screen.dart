...
class SingleShowView extends StateMVC<SingleShowScreen> {
  ...
  ///check here if you have issue in a specfic platform
  bool platformCheck() {
        ...
        builder: (context, child, model) {
          return SingleChildScrollView(
            child: SafeArea(
              ...
              /// in case ios only
              child:  Padding(
                padding: platformCheck()? const EdgeInsets.only(top: 1):const EdgeInsets.only(top: 25),

                child: Column(
                  children: <Widget>[
                    Container(
                      width: MediaQuery.of(context).size.width,
                      ///never put a static height, try to control the image height and width instead
